...
if ($(".rihla-info").length && $(window).width() > 800) {
  ...
  $(document).ready(function () {
    ...
    $(window).scroll(function () {
      ...
      let postsContentBottom =
        postsContentOffsetTop + postsContent.height() - 20;
...
if ($(".land").length > 0) {
  function showPlaneForm() {
    $(".booking-info").hide();
    $(".booking-info.plane").show();
    $("#plane").addClass("active");
    $("#hotel, #trip").removeClass("active");
  }
  $("#plane").click(showPlaneForm);

  // Event listener for clicking on the "hotel" li
  $("#hotel").click(function () {
    $(".booking-info").hide();
    $(".booking-info.hotel").show();
    $("#hotel").addClass("active");
    $("#plane, #trip").removeClass("active");
  });

  // Event listener for clicking on the "trip" li
  $("#trip").click(function () {
    $(".booking-info").hide();
    $(".booking-info.trip").show();
    $("#trip").addClass("active");
    $("#plane, #hotel").removeClass("active");
  });
...
$(function () {
  ...
  $(".my-login-validation.my-register").submit(function () {
    var form = $(this);
    if (form[0].checkValidity() === false) {
      event.preventDefault();
      event.stopPropagation();
